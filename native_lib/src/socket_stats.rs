...
impl InstancedDefault<Control,Sender<Action>> for ConnectionIndicator{
...
impl Windowed<Action> for ConnectionIndicator{
    const BG_HIGHLIGHT_COLOR:Color = Color{r:255.0,g:25.0,b:0.0,a:1.0};
    const BG_COLOR:Color = Color{r:255.0,g:0.0,b:0.0,a:1.0};
