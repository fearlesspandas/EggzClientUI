...
onready var arm_resource = load("res://entity/server/tutorial/AxisArmServer.tscn")
onready var core_resource = load("res://entity/server/tutorial/AxisCoreServer.tscn")
