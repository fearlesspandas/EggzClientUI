...
func _ready():
	...
	vertical.set_collision_mask_bit(EntityConstants.SERVER_PLAYER_COLLISION_LAYER,true)	
	...
	horizontal.set_collision_mask_bit(EntityConstants.SERVER_PLAYER_COLLISION_LAYER,true)	
	...
	elbow.set_collision_mask_bit(EntityConstants.SERVER_PLAYER_COLLISION_LAYER,true)	
